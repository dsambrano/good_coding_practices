...
- How to collaborate with any other scientist using GitHub
...
<!-- excerpt-start -->
GitHub (and GitLab an open source alternative) are primarly used (for scientific programming) as remote (i.e., cloud-based) repositories/server/storage locations. 
