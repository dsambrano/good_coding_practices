...
Finally, add all those commands to a file, so you can setup the folder structure for all new projects (we didnt discuss how to make workable scripts, but for now, you can just copy and paste for now).
