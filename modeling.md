...
Of course if you already are familar with their utility, feel free to skip to the next [section](#myfirstmodel).
...
![THIS IS SUPPOSED TO BE AN IMAGE OF A SCHEMATIC BASED MODEL](image.png)
